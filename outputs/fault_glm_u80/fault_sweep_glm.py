...
OUTPUT_BASE_DIR = Path(__import__("os").environ.get("FS_OUT", "/tmp/claude-7923/-w-ee-00-puneet-karfakis-hmwrk-ee247/c038e1cb-cc19-4081-aa55-d5fd27dd7a23/scratchpad/fault_glm_u80"))
