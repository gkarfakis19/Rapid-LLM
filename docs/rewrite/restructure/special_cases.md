...
5. **`llm_execution.py:597`** — the MoE rejection, which is not a policy but a load-bearing guard against a genuinely broken EP path in the FINE builder, in direct contradiction of CONTEXT constraint 4.
